...
$query= mysqli_query($con, "SELECT * FROM `discussion_master` WHERE dis_id='{$_GET['did']}'");
            ...
            <div class="card-body">
                ...
                <i class="fa fa-file-text-o"></i>
                 ...
                 <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                      <textarea class="form-control" rows="4" id="input-9" name="query" readonly="true" required><?php echo $querydata['discussion']?></textarea>
                  </div>
                </div>    
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <textarea class="form-control" rows="4" id="input-9" name="comment" required></textarea>
                  </div>
                </div>
