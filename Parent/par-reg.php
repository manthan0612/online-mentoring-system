...
if(isset($_POST['btn']))
{
    ...
    $stu_enroll= mysqli_real_escape_string($con,$_POST['stu_enroll']);
    $email= mysqli_real_escape_string($con,$_POST['email']);
    $pass= sha1(mysqli_real_escape_string($con,$_POST['pass']));
    $cpass= sha1(mysqli_real_escape_string($con,$_POST['cpass']));
    
    
    /*$id= mysqli_query($con,"select * from parent_master where par_id='{$branch}'");
    $iddata= mysqli_fetch_array($id);*/
    
    if($pass==$cpass)
    {
            
        $q= mysqli_query($con,"INSERT INTO `parent_master` ( `u_id`, `par_name`,`par_phn`,`stu_enroll`,`par_email`, `par_pass`, `status`) VALUES ( '4', '{$name}', '{$phn}','{$stu_enroll}', '{$email}', '{$pass}', '1');") or die(mysqli_error($con));
...
//        $notifications= mysqli_query($con, "INSERT INTO `notification_master` ( `n_from`, `n_to`,`b_id`,`id`,`notification`, `status`) VALUES ( '3', 'Admin','{$branch}','{$iddata['admin_id']}','New Student Added', '1');");
        ...
        if($q)
        {
            echo "<script>alert('Signup Successfully');window.location='../login.php';</script>";
        }
        else {
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
            <h4 class="page-title">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Parent Signup Form</h4>
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                  <label for="input-4" class="col-sm-2 col-form-label">Student Enroll No</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="input-4" name="stu_enroll" required>
                  </div>
                </div>
