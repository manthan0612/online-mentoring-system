...
if(isset($_GET['fid']))
{
   $d= mysqli_query($con, "update faculty_master set staus=1 where f_id='{$_GET['fid']}'");
   if($d)
   {
       echo "<script>alert('Active Successful');window.location='dis-deleted-faculty.php';</script>";
   }
}
?>
<script>
  ...
  <div class="content-wrapper">
    ...
    <!-- End Breadcrumb-->
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-table"></i> Deleted Students List</div>
            <div class="card-body">
