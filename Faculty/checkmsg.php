...
$res="";
$res1="";
$sql=mysqli_query($con,"select * from query_master where   msg_from='{$_POST['faculty']}'  and msg_to='{$_POST['stu']}' or msg_from='{$_POST['stu']}'  and msg_to='{$_POST['faculty']}'  order by q_time desc ");
    ...
    while($row=mysqli_fetch_array($sql))
    {
      ...
      if($row['msg_to']==$_SESSION['fid'])
      {
       ...
       // $res=$res."<img src='' class='left' alt='Avatar' class='right' style='width:100%;'>";
         if($row['is_seen']==2)
         {
          ...
          $res=$res."<div class='container '>"; 
          $res=$res."<p><b>Student</b>: $row[query]&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='chat.php?id=$row[q_id]' class='left'>Delete</a></p>";
      ...
      //  $res=$res."<img src='user.png' class='left' alt='Avatar' class='right' style='width:100%;'>";
       ...
       if($row['is_seen']==2)
       {
          ...
          $res=$res."<div class='container darker'>"; 
        $res=$res."<p><b>You</b>: $row[query]&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='chat.php?id=$row[q_id]' class='left'>Delete</a></p>";
