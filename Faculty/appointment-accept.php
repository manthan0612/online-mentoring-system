...
if(isset($_POST['btn']))
{
    ...
    $apptime= mysqli_real_escape_string($con,$_POST['app-time']);
     ...
     $notificationq=mysqli_query($con,"INSERT INTO `notification_master` ( `n_from`, `n_to`,`b_id`,`id`,`notification`, `status`) VALUES ( '3', 'Student','{$_SESSION['fb_id']}','{$facultydata['stu_id']}','Appointment Accepted', '1');");
     if($q)
     {
